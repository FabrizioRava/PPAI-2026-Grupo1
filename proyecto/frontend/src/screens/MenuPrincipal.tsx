  ...
  const opciones: OpcionMenu[] = [
    {
      ...
      descripcion:
        'Visualizá sobre el mapa la posición en tiempo real de los bolsines enviados desde tu Comisión Médica.',
      disponible: true,
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex flex-col items-end leading-tight">
              ...
              <span className="text-[0.625rem] text-brand-bgMain/60 font-medium">
                {usuario.rol} • {usuario.comisionMedica.nombre}
              </span>
            </div>
            <div
              className="w-9 h-9 rounded-full bg-gradient-to-tr from-brand-primary to-brand-secondary flex items-center justify-center text-white text-xs font-bold shadow-sm"
              aria-hidden="true"
            >
