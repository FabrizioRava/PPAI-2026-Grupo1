      ...
      <div className={`${glassPanel} w-full max-w-md rounded-3xl p-8 sm:p-10`}>
        ...
        <form onSubmit={tomarInicioSesion} className="mt-8 flex flex-col gap-4">
                ...
                {verPassword ? (
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029M9.88 9.88a3 3 0 104.24 4.24M9.88 9.88l4.24 4.24M9.88 9.88L4.46 4.46m4.42 5.42l5.66 5.66m0 0L19.54 19.54"
                    />
                  </svg>
                ) : (
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
          ...
          {error && (
            <div
              role="alert"
              className="flex items-center gap-2 bg-rose-50/80 border border-rose-200/80 text-rose-800 rounded-xl px-3.5 py-2.5 text-xs font-bold"
            >
              <svg
        ...
        <div className="mt-6 bg-white/40 border border-white/60 rounded-xl p-3.5 text-xs text-brand-bgMain/70 leading-relaxed">
          ...
          <p>
            Contraseña <strong>1234</strong> para todos. Usuarios: <span className="font-mono">jperez</span> (Villa
            María), <span className="font-mono">agomez</span> (Córdoba), <span className="font-mono">cruiz</span> (Río
            Cuarto).
          </p>
        </div>
      </div>

      <footer className="mt-6 text-xs text-brand-bgMain/45">PPAI 2026 · Grupo 1 · CU36 Seguimiento de Bolsines</footer>
    </div>
  );
};
